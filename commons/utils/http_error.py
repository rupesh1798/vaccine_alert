...
class GatewayTimeout(HttpError):
    ...
    def __init__(self, message="Cant connect to server at this moment.\nIf the issue persists please contact support.", error_code=None, errors=None):
        super(GatewayTimeout, self).__init__(self.status_code, message, error_code, errors)
